...
class BaseControl(Node):
    def __init__(self):
        ...
        self.odomId = 'odom'
        self.imuId = 'imu'
        self.device_port = '/dev/move_base'
        ...
        self.motor_type = ["25GA370","37GB520","BLDC_HALL","37GB545-ChiHai","37GB545-Custom"]
        ...
        self.communication_timer = self.create_timer(1.0/100,self.communication_timerCB)
            ...
            if len(reading)!=0:
                for i in range(0,len(reading)):
                    ...
                    try:
                        ...
                        #     self.get_logger().info("Circleloop.enqueue Succeed")
                        # self.serial_error = False
                    except:
                        pass
                        # self.get_logger().info("Circleloop.enqueue Faild: {}".format(self.Circleloop.get_queue_length()))
                ...
                if data == 0x5a:
                    ...
                    if length > 1 :
                        if self.Circleloop.get_front_second() <= self.Circleloop.get_queue_length():
                            ...
                            # print(self.Circleloop.get_front_second(),self.Circleloop.get_queue_length())
                            # self.get_logger().info("Variable 1: {}, Variable 2: {}".format((self.Circleloop.get_front_second()), (self.Circleloop.get_queue_length())))
                            loopcounter = 11 #break this loop
                    else:
                        # self.get_logger().info("Not Valid length")
                        loopcounter = 11
                        pass
                else:
                    # self.get_logger().info("Not Valid Head")
                    self.Circleloop.dequeue()
            else:
                # self.get_logger().info("Circle is Empty")
